...
#	the real thing is here...
	g++ -o ./bin/jvstwrapper.so -shared -fPIC -O0 -g -Wall -rdynamic -ldl -I/usr/include -I./src/src/public.sdk/vst2.x -I$(JAVA_HOME)/include -I$(JAVA_HOME)/include/linux  src/src/jVSTwRapperMAIN.cpp

release:
#	debug build option as executable so that all errors are reported!
#	g++ -o ./bin/jvstwrapper.so -O2 -Wall -rdynamic -ldl -I/usr/include -I./src/src/public.sdk/vst2.x -I$(JAVA_HOME)/include -I$(JAVA_HOME)/include/linux  src/src/jVSTwRapperMAIN.cpp
