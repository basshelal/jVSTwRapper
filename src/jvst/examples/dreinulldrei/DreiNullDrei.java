...
public class DreiNullDrei extends VSTPluginAdapter {
  ...
  public String getVendorString() { return "Daniel Martin"; }
  ...
  public int canDo(String feature) {
    ...
    if (DreiNullDrei.PLUG_RECEIVE_VST_EVENTS.equals(feature)) ret = DreiNullDrei.CANDO_YES;
    if (DreiNullDrei.PLUG_REVEIVE_VST_MIDI_EVENT.equals(feature)) ret = DreiNullDrei.CANDO_YES;
    if (DreiNullDrei.PLUG_MIDI_PROGRAM_NAMES.equals(feature)) ret = DreiNullDrei.CANDO_YES;
